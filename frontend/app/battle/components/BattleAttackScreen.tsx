...
export default function BattleAttackScreen({
  ...
  const messageSizeClass =
    message.length <= 20
      ? "text-3xl min-[1100px]:text-7xl"
      : message.length <= 50
        ? "text-2xl min-[1100px]:text-5xl"
  ...
  return createPortal(
    <div className={`battle-attack-screen fixed inset-0 z-[70] overflow-hidden bg-[#020817] text-white ${
      ...
      <div className="battle-attack-message absolute inset-x-4 bottom-[8%] z-20 flex items-center justify-center min-[1100px]:inset-y-0 min-[1100px]:left-auto min-[1100px]:right-[4%] min-[1100px]:bottom-auto min-[1100px]:w-[58%]">
        <div className="relative w-full -skew-x-3 border-y-2 border-cyan-300/70 bg-blue-950/80 px-5 py-7 shadow-[0_0_45px_rgba(37,99,235,0.5)] min-[1100px]:-skew-x-6 min-[1100px]:px-12 min-[1100px]:py-12">
      ...
      <div className="battle-attack-impact pointer-events-none absolute left-1/2 top-[44%] z-30 h-14 w-14 -translate-x-1/2 -translate-y-1/2 rounded-full border-4 border-white min-[1100px]:left-[42%] min-[1100px]:top-1/2 min-[1100px]:h-20 min-[1100px]:w-20" />
    </div>,
    document.body,
  );
}
